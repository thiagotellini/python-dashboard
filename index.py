                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            ...
                            html.Legend("Thiago Tellini")
                        ])
                    ], style={'margin-top': '10px'}),
                    dbc.Row([
                        dbc.Button("Veja meu portfólio", href="https://thiagotellini.com.br", target="_blank")
                    ], style={'margin-top': '10px'})
                ])
            ], style=tab_card)
        ], sm=4, lg=2),
...
def graph5(month, toggle):
    ...
    fig5.add_trace(go.Indicator(mode='number+delta',
        title = {"text": f"<span>Top Consultor ({df_5['Consultor'].iloc[0]})</span><br><span style='font-size:70%'>Em vendas - em relação a média</span><br>"},
    ...
    fig6.add_trace(go.Indicator(mode='number+delta',
        title = {"text": f"<span>Top Time ({df_6['Equipe'].iloc[0]})</span><br><span style='font-size:70%'>Em vendas - em relação a média</span><br>"},
